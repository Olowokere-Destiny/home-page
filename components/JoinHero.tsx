...
export default function JoinHero() {
  return (
    <section className="relative w-full h-190 md:h-150 lg:landscape:h-[90vh] xl:landscape:h-[90vh] xl:landscape:pt-4 overflow-hidden sm:pb-4">
      ...
      <div className="relative z-10 -translate-y-20 sm:translate-y-0 xl:landscape:-translate-y-20 flex flex-col justify-center h-full max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="bg-[#76767699]/60 rounded-xs px-4 py-3 flex flex-col gap-3 w-full md:w-fit">
